...
export default class GroceryProductsList extends Component {
    constructor(props) {
      super(props);  
    ...
    productList() {
        ...
        const grocery = this.state.products.filter( product => product.category == 'Grocery')
        
      return grocery.map((currentproduct) => {
        return (
          <Product
